    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <img class="img-profile img-circle img-bordered-sm"
                    src="https://petmaster.vn/petroom/wp-content/uploads/2020/04/gia-meo-anh-long-dai-5.jpeg" alt="avatar" width="35px" height="35px">
            </a>
