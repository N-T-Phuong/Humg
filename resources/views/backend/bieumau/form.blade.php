                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <section id="thong-tin-nguoi-nop-wrapper" style="margin: 30px 0 0 0">
                                        <form id="mainForm" name="mainForm" action="{{route('hoso.store')}}"
                                            method="POST" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <div id="form-content">
                                                <fieldset id="fs-thong-tin-nguoi-nop" class="form-wrapper ui-sortable">
                                                    <input name="tt_id" type="hidden" class="form-control"
                                                        value="{{ $thutuc->id }}">
                                                    <div id="row-1" class="row ui-sortable ui-sortable-handle">
                                                        <div id="column-1"
                                                            ...
                                                            <div id="" class="form-group text">
                                                                ...
                                                                <input id="tenSV" name="sv_id" type="text"
                                                    ...
                                                    <div id="row-2" class="row ui-sortable ui-sortable-handle">
                                                        <div id="column-3"
                                                            ...
                                                            <div id="diDong" class="form-group text">
                                                                <label id="_lbl_diDong" class="control-label"
                                                                    for="phone">
                                                        ...
                                                        <div id="column-4"
                                                            class="col-md-6 col ui-sortable ui-sortable-handle">
                                                            <div id="" class="form-group text">
                                                                <label id="_lbl_email" class="control-label"
                                                                    for="email">
                                                    ...
                                                    <div id="row-3" class="row ui-sortable ui-sortable-handle">
                                                        <div id="column-5"
                                                            ...
                                                            <div id="" class="form-group text">
                                                                ...
                                                                <input id="khoa" name="khoa" type="text"
                                                        ...
                                                        <div id="column-6"
                                                            ...
                                                            <div id="website" class="form-group text">
                                                                <label id="_lbl_website" class="control-label"
                                                                    for="lop">
                                                                    <span class="label-content">Lớp</span>
                                                                    <span class="color-err"
                                                                        title="Trường bắt buộc">*</span>
                                                                </label>
                                                                <input id="lop" name="lop" type="text"
                                                                    class="form-control" value="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div id="row-4" class="row ui-sortable ui-sortable-handle">
                                                        <div id="column-7"
                                                            class="col-md-4 col ui-sortable ui-sortable-handle">
                                                            <div id="" class="form-group text">
                                                        ...
                                                        <div id="column-8"
                                                            ...
                                                            <div id="website" class="form-group text">
                                                                ...
                                                                <input id="noi_cap" name="noi_cap" type="text"
                                                                    class="form-control" value="">
                                                            </div>
                                                        </div>
                                                    </div>
