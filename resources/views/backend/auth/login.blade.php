            ...
            <div class=" o-hidden border-0 shadow-lg my-5 ">
                <div class="card-body p-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 offset-3 bg-white ">
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="{{route('auth.login')}}">
                                    ...
                                    {{--<a href="{{route('admin.auth.login')}}" class="btn btn-primary btn-user btn-block"> Đăng nhập </a>--}}
                                    {{--<hr>--}}

                                </form>
                                {{--<div class="text-center">--}}
                                    {{--<a class="small" href="forgot-password.html">Đổi mật khẩu</a>--}}
                                {{--</div>--}}
                                {{--<div class="text-center">--}}
                                    {{--<a class="small" href="register.html">Thay đổi thông tin</a>--}}
                                {{--</div>--}}
                            </div>
                        </div>
                    </div>
