                ...
                <div class="card o-hidden border-0 shadow-lg my-5 ">
                    <div class="card-body p-5">
                        ...
                        <form class="user" method="post" action="{{route('login')}}">
                            ...
                            <div class="form-group">
                                <input type="password" name="password" class="form-control form-control-user @error('password') is-invalid @enderror" name="password" required id="exampleInputPassword" placeholder="Password">
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <button type="submit" class="btn btn-primary btn-user btn-block" style="font-size: 18px;"><i class="fas fa-lock mr-3"></i>Đăng nhập</button>
                            <hr>
                        </form>
                        <div class="text-center">
