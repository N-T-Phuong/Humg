                            ...
                            <div class="header__wrap">
                                <div class="col-sm-12 col-xs-5 full-xs">
                                    <div class="header__logo">
                                        <a href="/">
                                            <img src="{{asset('hs/img/humg1.jpg')}} " width="300%" height="55px"
                                                alt="LOGO">
                                        </a>
                                    </div>
                                    <div class="header__account account col-xs-3 pull-right  "
                                        style="margin-top: -3em;">
                                        {{--<div class="account__action">--}}
                                        {{--<a href="{{route('auth.login')}}" class="text-uppercase color-header
                                        font-size-13 font-weight-bold text-red">Đăng nhập</a>--}}
                                        {{--</div>--}}
                                        @if( Auth::check())
                                        <div class="heli" style="display:inline-block">
                                            <a href="#"
                                                class="text-capitalize font-italic color-header font-size-14 font-weight-bold text-red"
                                                data-toggle="dropdown" id="drop55" role="button" aria-haspopup="true"
                                                aria-expanded="false">
                                                User: {{ Auth::user()->name }}
                                            </a>
