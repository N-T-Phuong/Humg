                        ...
                        <div class="card-header py-3">
                            ...
                            <form id="mainForm" name="mainForm" action="{{route('login')}}" method="post">
                                    ...
                                    <div id="column" class="col-md-8 col ofset-2">
                                        <div id="P_TEN_DANG_NHAP" class="form-group text">
                                            <label id="" class="control-label">
                                                <span class="label-content">Tên đăng nhập hoặc email</span>
                                            </label>
                                            <input id="" name="email" type="text" placeholder=" Nhập email đăng nhập"
                                        ...
                                        <div id="" class="form-group text">
                                            ...
                                            <input id="" name="password" type="password" placeholder="Nhập mật khẩu"
                                ...
                                <div class="row">
                                    <div class="col-md-2"></div>
                                    <div class="col-md-4">
                                        <button type="submit" class="btn btn-success btn-block" id="btn-login"> <i
                                                class="fas fa-lock "></i> Đăng nhập</button>
                                    </div>
                                    <div class="col-md-4">
